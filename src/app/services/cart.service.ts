...
export class CartService {
    ...
    addItem(productInOrder): Observable<boolean> {
        if (!this.currentUser) {
            ...
            return this.http.post<boolean>(url, {
                ...
                'kecap': productInOrder.kecap,
                'majonez': productInOrder.majonez,
                'sahara': productInOrder.sahara,
                'seville':productInOrder.seville,
                'texasBbq':productInOrder.texasBbq,
                'ninjaBlend':productInOrder.ninjaBlend,
                'kari':productInOrder.kari,
                'siracha':productInOrder.siracha,
                'tostSir': productInOrder.tostSir,
                'cedar':productInOrder.cedar,
                'zdenka':productInOrder.zdenka,
                'gorgonzola':productInOrder.gorgonzola,
                'slanina':productInOrder.slanina,
                'jalapeno':productInOrder.jalapeno,
                'hrskaviLuk':productInOrder.hrskaviLuk,
                'guacamole':productInOrder.guacamole,
                'mariniranaPiletina':productInOrder.mariniranaPiletina,
                'mlevenaJunetina':productInOrder.mlevenaJunetina,
                'rostiljKobasica':productInOrder.rostiljKobasica,
                'chickenNugets':productInOrder.chickenNugets,
                'cordonBleu':productInOrder.cordonBleu,
                'falafel':productInOrder.falafel,
                'besplatniSos':productInOrder.besplatniSos,
                'gauda':productInOrder.gauda,
                'sampinjoni':productInOrder.sampinjoni,
                'barbecue':productInOrder.barbecue,
                'posebanZahtev':productInOrder.posebanZahtev,
    ...
    checkout(): Observable<any> {
        ...
        console.log(this.cartUrl + "Checkout");
